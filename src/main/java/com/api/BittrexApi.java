...
@ClientEndpoint
@EnableScheduling
public class BittrexApi extends ApiProcessor {
	...
	public static BigDecimal getPriceCoin(String shortNameCoin, String shortNameCoinPair) {
		...
		PriceBittrex result = restTemplate
				.getForObject(getUrlApiByExchangeName(EXCHANGE_NAME, shortNameCoin, shortNameCoinPair), PriceBittrex.class);
		
		return new BigDecimal(result.getResult().getLast());
